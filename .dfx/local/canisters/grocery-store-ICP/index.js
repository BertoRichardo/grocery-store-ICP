...
import { idlFactory } from './grocery-store-ICP.did.js';
export { idlFactory } from './grocery-store-ICP.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GROCERY-STORE-ICP_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./grocery-store-ICP.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the grocery-store-ICP canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./grocery-store-ICP.did.js")._SERVICE>}
 */
export const grocery-store-ICP = createActor(canisterId);
